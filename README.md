...
The common (C) terminal of the BD3F controller represents the negative side and is connected to the TLP127 emitter. The temperature sensor (T) pin is connected to its collector.
