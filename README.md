...
* `defmin <0..100>`: Set the minimum allowed compressor duty cycle in percent for starting a defrost cycle
* `defmax <0..100>`: Set the maximum allowed compressor duty cycle in percent for starting a defrost cycle
